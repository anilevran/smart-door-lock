...
export function WifiCredentials(props) {
  var [ssid, setSsid] = useState("");
  var [password, setPassword] = useState("");
  

  const handleCredentials = (props) => {
    try {
      axios
        .post("http://192.168.1.184:80/setCredentials", {
          lockId: lockId,
          ssid: ssid,
          password: password,
      ...
      <View style={styles.body}>
        ...
        <View style={styles.formContainer}>
          ...
          <View style={styles.buttonContainer}>
            <TouchableHighlight underlayColor="none" onPress={handleCredentials}>
